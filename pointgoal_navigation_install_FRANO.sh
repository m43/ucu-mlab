...
conda create -n vimam python=3.6 cmake=3.14.0 -y
source ~/miniconda3/etc/profile.d/conda.sh
conda activate vimam
...
# ----------------------------------------------------------------------------
cd pointgoal-navigation-hc-2021-eval.ai
...
# FRANO #
#########
#ln -s /mnt/terra/data /mnt/terra/xoding/pointgoal-navigation-hc-2021-eval.ai/data/scene_datasets
